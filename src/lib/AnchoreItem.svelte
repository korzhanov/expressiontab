<script lang="ts">
  ...
  let maxVisits: number = localStorage.getItem("maxVisits") * 1 || 500;
...
"
  ...
  <a {ping} href={url}>
    <anchoricon
    transition:scale="{{duration: 500, delay: 50, opacity: 0.5, start: 0.5, easing: quintOut}}"
  ...
  {#if multiButton}
    ...
    >
      <button class:isBookmark title="Bookmark"
...
<style lang="scss">
  ...
  anchor {
    ...
    & bgcircle {
      ...
      top: 0;
      z-index: -1;
      filter: brightness(01) contrast(01) saturate(01.3) blur(5px);
